...
const HudStatus = () => {
  ...
  return (
    <footer className="relative z-30 w-full px-4 sm:px-8 py-3 select-none flex items-center justify-center">
      
      {/* Expanded Bottom-Center Cyber HUD Dock */}
      <div 
        className="relative group bg-[#090e1a]/90 border border-cyan-500/30 px-4 sm:px-6 py-2.5 rounded-lg backdrop-blur-md font-mono shadow-[0_0_25px_rgba(0,0,0,0.85)] flex flex-wrap items-center justify-center gap-4 sm:gap-7 md:gap-8 max-w-5xl"
      ...
      >
        ...
        <div className="flex items-center gap-2 text-xs">
          ...
          <div className="flex flex-col text-left">
            ...
            <span className="text-cyan-300 font-bold tracking-wider text-[11px] sm:text-xs">
              DELHI, INDIA
            </span>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2 text-xs">
          ...
          <div className="flex flex-col text-left">
            ...
            <span className="text-pink-400 font-bold tracking-wider text-[11px] sm:text-xs">
        ...
        <div className="flex items-center gap-2 text-xs">
          ...
          <div className="flex flex-col text-left">
            ...
            <span className="text-emerald-400 font-bold tracking-wider text-[11px] sm:text-xs flex items-center gap-1.5">
        ...
        {/* Divider */}
        <div className="hidden md:block w-[1px] h-7 bg-cyan-500/20" />
